 ...
 */
final class Version20260202093114 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_document CHANGE statut_demande statut_demande VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE demande_document RENAME INDEX fk_demande_utilisateur TO IDX_9E30C3B412B2DC9C');
        $this->addSql('ALTER TABLE document CHANGE disponible disponible INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE emprunt CHANGE date_emprunt date_emprunt DATETIME NOT NULL, CHANGE date_retour_reelle date_retour_reelle DATETIME DEFAULT NULL, CHANGE prolonge prolonge INT NOT NULL');
        ...
        $this->addSql('DROP INDEX fk_utilisateur_role ON utilisateur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_document CHANGE statut_demande statut_demande VARCHAR(50) DEFAULT \'\'\'En attente\'\'\' NOT NULL');
        $this->addSql('ALTER TABLE demande_document RENAME INDEX idx_9e30c3b412b2dc9c TO fk_demande_utilisateur');
        $this->addSql('ALTER TABLE document CHANGE disponible disponible TINYINT DEFAULT 1 NOT NULL');
        ...
        $this->addSql('ALTER TABLE emprunt CHANGE date_emprunt date_emprunt DATETIME DEFAULT \'current_timestamp()\' NOT NULL, CHANGE date_retour_reelle date_retour_reelle DATETIME DEFAULT \'NULL\', CHANGE prolonge prolonge TINYINT DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE password password VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE utilisateur ADD CONSTRAINT `fk_utilisateur_role` FOREIGN KEY (id_role) REFERENCES role (id_role)');
        $this->addSql('CREATE INDEX fk_utilisateur_role ON utilisateur (id_role)');
